...
const UpdateForm = props => {
  ...
  const { updateModalVisible, handleUpdateModalVisible, values ,form,handleUpdate} = props;
  const okHandle = () => {
    form.validateFields((err, fieldsValue) => {
      if (err) {
        return;
      ...
      fieldsValue = {...fieldsValue,key:values.key};
    ...
    >
      ...
      >
        {form.getFieldDecorator('student_name', {
          ...
          initialValue:values.student_name
        })(<Input placeholder="请输入" />)}
      </FormItem>
      <FormItem
        labelCol={{
      ...
      >
        {form.getFieldDecorator('student_class', {
          ...
          initialValue: values.student_class,
